...
contract TestContract is ERC721A, Ownable { 
    constructor() ERC721A("Test", "TESTR2") { }
    ...
    function allowListMint(uint256 quantity, bytes32 hash, bytes memory signature) external payable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        output = string.concat('{"name":"#',_toString(tokenId),'", "description":"Test.","attributes":',makeTraits(chub),', "image":"', output, '"}'); 
