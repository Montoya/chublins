...
contract Chublin is Ownable, ERC721A, ReentrancyGuard {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600" width="600" height="600">';
        parts[1] = '<rect width="100%" height="100%" fill="#c0caff"/>';
        parts[2] = '</svg>';

        string memory output = string(abi.encodePacked(parts[0], parts[1], parts[2]));

        parts[0] = '[{"trait_type":"Status","value":"';
        parts[1] = 'Test_1';
        parts[2] = '"}]';
        ...
        json = string(abi.encodePacked('{"name":"',nftName,'", "description":"A cute creature generated and stored entirely on-chain.","attributes":',json));
